...
<body>
  ...
  <!-- Page Content -->
  <section style="height: 90vh;" class="scree-height">
      <div class="row h-45">
          <!-- First Box -->
          <div class="col-md-6">
              <div class="custom_card w-100">
                  <div class="row no-gutters d-flex align-items-center w-100 h-100 w-100 d-flex align-items-center">
                          <div class="col-md-6 mt-3 h-75 w-100 d-flex justify-content-center align-items-center">
                              <div class="row">
                                  ...
                                  <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-4 d-flex">
                                  ...
                                  <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-4 d-flex">
                                      ...
                                      <p class="d-flex align-items-center justify-content-cente font-weight-bold circles_font_size">
                                          LOW OIL
                                      </p>
                                  </div>
                                  <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-4 d-flex">
                          ...
                          <div class="col-md-6 h-100 d-flex align-content-center justify-content-center flex-column">
                              <div class="row">
                                  <div class="col-12" style="width: 100% !important;">
                                      <p class="d-flex align-items-center justify-content-center">
                                          <span class="mr-3 tempText">Oil Temperature :</span>
                              ...
                              <div class="row mt-3">
                                  <div class="col-12" style="height: 140px;">
                                      <div id="lift_chart">Lift chart</div>
                                  </div>
                              </div>
                          </div>
                  </div>
